...
void Scene::setup(Camera &camera) {
    ...
    loadPedestal(Transform(glm::vec3(0.0, -0.5, -0.6), glm::vec3(0), glm::vec3(1)), mat2, mat2,
                 "resources/SuzanneSmall.obj");
    loadPedestal(Transform(glm::vec3(0.3, -0.5, -0.6), glm::vec3(0), glm::vec3(1)), mat2, mat2,
                 "resources/TeapotSmall.obj");
    loadPedestal(Transform(glm::vec3(0.6, -0.5, -0.6), glm::vec3(0), glm::vec3(1)), mat2, mat2,
                 "resources/ArmadilloSmall.obj");
    loadPedestal(Transform(glm::vec3(0.9, -0.5, -0.6), glm::vec3(0), glm::vec3(1)), mat2, mat2,
                 "resources/ApeSmall.obj");
    loadPedestal(Transform(glm::vec3(1.2, -0.5, -0.6), glm::vec3(0), glm::vec3(1)), mat2, mat2, "resources/House.obj");
